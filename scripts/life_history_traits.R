...
pantheria <- select(pantheria, MSW05_Order, MSW05_Genus, MSW05_Species, MSW05_Binomial, X5.1_AdultBodyMass_g, 
                    X6.1_DietBreadth, X12.1_HabitatBreadth, X22.1_HomeRange_km2) %>% 
